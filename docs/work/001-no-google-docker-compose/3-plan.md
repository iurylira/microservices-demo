...
- [x] P3-07 (implementation) frontend remove GCP metadata / deployment detection  -> maps T-001, T-009, T-020
- [x] P3-08 (implementation) frontend remove Cloud Profiler  -> maps T-001, T-009
- [x] P3-09 (implementation) checkoutservice remove Cloud Profiler  -> maps T-001, T-009
- [x] P3-10 (implementation) shippingservice remove Cloud Profiler  -> maps T-001, T-009
...
- [x] P3-16 (implementation) system font stack instead of Google Fonts  -> maps T-001, T-006, T-024
- [x] P3-17 (implementation) adservice neutral trace log keys  -> maps T-001, T-007
...
- [x] P3-22 (implementation) [high-risk] cartservice csproj drop Google/Npgsql packages  -> maps T-008, T-010
- [x] P3-23 (implementation) [high-risk] currencyservice drop @google-cloud deps + regen lockfile  -> maps T-001, T-004, T-019
- [x] P3-24 (implementation) [high-risk] paymentservice drop @google-cloud dep + regen lockfile  -> maps T-001, T-004, T-019
- [x] P3-25 (implementation) [high-risk] emailservice drop google deps + recompile requirements  -> maps T-001, T-005, T-019
...
- [x] P3-28 (implementation) [high-risk] Node Dockerfiles drop profiler-only toolchain  -> maps T-001, T-004, T-019
- [x] P3-29 (implementation) [high-risk] emailservice/adservice Dockerfiles remove dead profiler config  -> maps T-001, T-005, T-019
